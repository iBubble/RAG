              ...
              {activeTable ? (
                <div className="flex-1 flex flex-col h-full overflow-hidden">
                  <div className="flex flex-wrap items-center justify-between px-6 py-4 border-b border-gray-100 gap-3">
                    ...
                    {/* 表格操作快捷键 */}
                    {editor && (
                      <div className="flex items-center gap-1 bg-white dark:bg-[#1E1F22] px-2 py-1 rounded-lg border border-gray-200 dark:border-stone-800 flex-wrap">
                        ...
                        <button onClick={() => editor.chain().focus().addRowAfter().run()} className="p-1 hover:bg-gray-100 dark:hover:bg-stone-800 rounded flex items-center gap-0.5" title="下方增行"><Plus className="w-3 h-3" /><ChevronDown className="w-3 h-3" /></button>
                        <button onClick={() => editor.chain().focus().addRowBefore().run()} className="p-1 hover:bg-gray-100 dark:hover:bg-stone-800 rounded flex items-center gap-0.5" title="上方增行"><Plus className="w-3 h-3" /><ChevronUp className="w-3 h-3" /></button>
                        ...
                        <button onClick={() => editor.chain().focus().addColumnAfter().run()} className="p-1 hover:bg-gray-100 dark:hover:bg-stone-800 rounded flex items-center gap-0.5" title="右侧增列"><Plus className="w-3 h-3" /><Columns className="w-3 h-3" /></button>
