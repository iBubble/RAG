        ...
        <div className="sdx-office-theatre" style={{ position: 'relative', width: '100%', height: '750px', background: '#fdfaf2', borderRadius: '16px', overflow: 'hidden', border: '1px solid #e0dcd5', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
          ...
          <svg viewBox="0 0 1100 750" className="w-full h-full select-none" style={{ background: '#f8fafc' }}>
            ...
            {Object.keys(DEFAULT_POS).map((key) => {
              ...
              // 映射到原装的sundynix-desktop专家立绘与协调者贴图
              let sprite = a0;
              switch(key) {
                case 'chat': sprite = a0; break;
                case 'service': sprite = a1; break;
                case 'planner': sprite = a2; break;
                case 'summary': sprite = a3; break;
                case 'checker': sprite = a4; break;
                case 'precompute': sprite = a0; break;
                case 'vectorizer': sprite = a1; break;
                case 'graph': sprite = a2; break;
                case 'auditor': sprite = a3; break;
                case 'legal': sprite = a4; break;
                default: sprite = leadSprite;
              }
